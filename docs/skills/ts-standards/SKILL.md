...
description: Invoke when code-developer or quality-reviewer works on TypeScript files. Provides strict typing rules, union/intersection type patterns, generic constraints, utility type usage, and a PostToolUse hook that validates TypeScript file edits.
hooks:
  PostToolUse:
    - matcher: "Edit|Write"
      hooks:
